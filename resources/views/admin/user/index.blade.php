            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr class="">
                        <td>01</td>
                        <td>Admin</td>
                        <td><img src="{{URL('vendor/inspinia/img/a1.jpg')}}" style="width:35px; height: 35px;" alt=""></td>
                        <td>超级管理员</td>
                        <td>8</td>
                        <td>127.0.0.1</td>
                    ...
                    <tr class="">
                        <td>01</td>
                        <td>Admin</td>
                        <td><img src="{{URL('vendor/inspinia/img/a2.jpg')}}" style="width:35px; height: 35px;" alt=""></td>
                        <td>超级管理员</td>
                        <td>8</td>
                        <td>127.0.0.1</td>
                        <td>2017-5-7 18:20:47</td>
                    ...
                    <tr class="">
                        <td>01</td>
                        <td>Admin</td>
                        <td><img src="{{URL('vendor/inspinia/img/a3.jpg')}}" style="width:35px; height: 35px;" alt=""></td>
                        <td>超级管理员</td>
                        <td>8</td>
                        <td>127.0.0.1</td>
                        <td>2017-5-7 18:20:47</td>
                    ...
                    <tr class="">
                        <td>01</td>
                        <td>Admin</td>
                        <td><img src="{{URL('vendor/inspinia/img/a4.jpg')}}" style="width:35px; height: 35px;" alt=""></td>
                        <td>超级管理员</td>
                        <td>8</td>
                        <td>127.0.0.1</td>
                        <td>2017-5-7 18:20:47</td>
                        ...
                        <td>
                            <a href="javascript:;" onclick="">
                                <div id=""><span class="label label-danger">关闭</span></div>
                            </a>
                        </td>
                        <td>
                            <a href="" class="btn btn-primary btn-xs"> <i class="fa fa-paste"></i> 编辑</a>
